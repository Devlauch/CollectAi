...
const navItems = [
  ...
  )},
  {
    path: '/whatsapp', label: 'WhatsApp', icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12.79A9 9 0 1111.21 3a9 9 0 019.79 9.79zM22 22l-4.35-1.45a10.05 10.05 0 01-4.78-3.87L11 14l-4-1 1-4 .09-.27A10.05 10.05 0 0112 2c5.52 0 10 4.48 10 10a9.96 9.96 0 01-2.29 6.71L22 22z" />
      </svg>
  )}
];
